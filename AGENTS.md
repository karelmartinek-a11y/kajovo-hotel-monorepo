...
- Přihlášený portál i administrace používají sdílený `AppShell`. Portál má na mobilu, tabletu i desktopu pevné zápatí s nejvýše pěti ikonami Profil, Pokojská, Recepce, Snídaně a Údržba podle oprávnění a přiřazených rolí. Mobilní záhlaví a lišta jsou vysoké 20 px plus systémový bezpečný okraj u lišty; při nedostatku místa se ikony posouvají vodorovně. Sklad je dostupný z profilu. Přepnutí do sekce jiné role používá serverový výběr role. Záhlaví portálu obsahuje jazyk a ikonu odhlášení. Administrace si zachovává vlastní navigaci. Navigace respektuje aktivní roli a oprávnění.
