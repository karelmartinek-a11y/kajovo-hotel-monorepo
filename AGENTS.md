...
- Přihlášený portál i administrace používají sdílený `AppShell`: na desktopu stálý postranní panel, na tabletu přichycené záhlaví. Mobilní portál má pevné nízké záhlaví s logem a třemi přepínači jazyka ve formě vlajek a pevnou spodní lištu ikon povolených sekcí včetně profilu; lišta má vodorovný posuv, pokud se odkazy nevejdou. Mobilní portál nepoužívá vysouvací Menu ani jeho hledání. Administrace si zachovává vlastní mobilní navigaci. Navigace respektuje aktivní roli a oprávnění.
