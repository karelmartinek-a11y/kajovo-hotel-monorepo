...
- Přihlášený portál i administrace používají sdílený `AppShell`: na desktopu stálý postranní panel, na tabletu a mobilu přichycené záhlaví se samostatným odkazem na profil. Pokojský přehled na mobilu používá kompaktní tlačítko Menu a stálou spodní navigaci; jiné pohledy mají přímo dostupné odkazy na povolené sekce. Navigace respektuje roli a oprávnění; úzký řádek odkazů se posouvá vodorovně, nikoli celý dokument.
