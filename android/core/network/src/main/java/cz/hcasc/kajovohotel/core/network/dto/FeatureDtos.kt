...
data class ReservationAmenityDto(
    val kind: String,
    val state: String,
    val version: Int,
    val active: Boolean,
...
data class HousekeepingStayDto(
    ...
    val checked_in: String? = null,
    val checked_out: String? = null,
    val amenities: List<ReservationAmenityDto> = emptyList(),
)
...
data class HousekeepingRoomDto(
    ...
    val guest_label: String? = null,
    val departures: List<HousekeepingStayDto> = emptyList(),
    val arrivals: List<HousekeepingStayDto> = emptyList(),
    val stays: List<HousekeepingStayDto> = emptyList(),
    val arrival_today: Boolean,
    val departure_today: Boolean,
    val checked_out: Boolean,
    val occupied: Boolean,
    val persons: Int,
    val ready_for_arrival: Boolean = false,
)

data class HousekeepingRoomsOverviewDto(
    val date: String,
    val housekeeping_status_is_current: Boolean,
    val occupancy_date: String,
    val loaded_at: String,
