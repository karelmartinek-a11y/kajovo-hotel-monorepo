...
def _escaped_text(*codepoints: int) -> str:
    return ''.join(chr(codepoint) for codepoint in codepoints)


COMMON_ENCODING_DRIFT_REPAIRS: dict[str, str] = {
    _escaped_text(0x0070, 0x006f, 0x006b, 0x006f, 0x006a, 0x0073, 0x006b, 0x00c4, 0x0083, 0x00cb, 0x0087): 'pokojská',
    _escaped_text(0x0070, 0x006f, 0x006b, 0x006f, 0x006a, 0x0073, 0x006b, 0x0103, 0x02c7): 'pokojská',
    _escaped_text(0x00c4, 0x0083, 0x0139, 0x00ba, 0x0064, 0x0072, 0x00c4, 0x0085, 0x00c4, 0x00be, 0x0062, 0x0061): 'údržba',
    _escaped_text(0x0103, 0x015f, 0x0064, 0x0072, 0x013e, 0x017e, 0x0062, 0x0061): 'údržba',
    _escaped_text(0x0073, 0x006e, 0x00c4, 0x0083, 0x00c2, 0x00ad, 0x0064, 0x0061, 0x006e, 0x0102, 0x201e, 0x20ac, 0x203a): 'snídaně',
}
