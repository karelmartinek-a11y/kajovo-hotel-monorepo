...
from app.services.breakfast.sync import BetterHotelBreakfastClient
        ...
        return [
            {
                ...
                "guest_list": [
                    ...
                    {"food": 1, "guest": {"first_name": "Eva", "last_name": "Nova"}},
            ...
            },
            {
                ...
                "guest_list": [
                    {"food": 1, "guest": {"first_name": "Petr", "last_name": "Host"}},
                ],
            },
        ]
