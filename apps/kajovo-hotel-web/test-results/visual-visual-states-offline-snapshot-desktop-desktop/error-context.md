...
- generic [ref=e3]:
  ...
  - main [ref=e18]:
    - generic [ref=e19]:
      - heading "Offline" [level=2] [ref=e20]
      - paragraph [ref=e21]: Aplikace je bez připojení. Zkontrolujte síť a zkuste synchronizaci znovu.
      - generic [ref=e22]:
        - button "Zkusit znovu" [ref=e23] [cursor=pointer]
        - link "Pracovat offline režimem" [ref=e24] [cursor=pointer]:
          - /url: /
  - link "KÁJOVO" [ref=e25] [cursor=pointer]:
    - /url: /
```