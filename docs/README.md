...
Adresář `docs/` je centrální rozcestník current-state dokumentace pro web, admin, API, CI a produkční provoz.
...
- `docs/release-checklist.md`: release a deploy checklist pro aktivní webový provoz.
