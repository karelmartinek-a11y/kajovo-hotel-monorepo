...
> Historický dokument. Pro current-state provoz neplatí žádné dřívější Android závazky uvedené v tehdejším stavu repozitáře.
...
- dokumentace byla rozptýlená mezi kořen, `docs/` a archivní podklady
...
- hlavní README a current-state provozní dokumentace byly přepsány podle tehdejší struktury webu, adminu a API
...
- záměrné výjimky s CRLF zůstávají jen u Windows skriptů
