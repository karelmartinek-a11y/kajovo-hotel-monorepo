...
## A) Cíl
- Uzavřít closeout dokumentaci pro release readiness s auditovatelným cutover runbookem a checklistem.
- Dorovnat parity mapu tak, aby neodkazovala na odstraněné mock nebo fallback closeout artefakty.
...
- Potvrdit release-owner signoff pro `BLOCKED` položky uvedené v parity mapě.
