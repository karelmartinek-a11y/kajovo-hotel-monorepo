...
| 15 | DONE | `docs/regen/15-nav-tablet-initial-state-fix`, `docs/regen/15-policy-entityid-fix` | `ORF-15 (current)` | None | Slot 15 uzavřen (nav media-state + policy Entity ID rename fix). |
